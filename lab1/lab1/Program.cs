...
namespace lab1
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            //shrt = x / y;//Так не будет работать
            Console.WriteLine("Введите 'y', если ходите продолжить: ");
            v = Convert.ToChar(Console.ReadLine());
            if (v == 'y')
            {
            ...
            //2ZADANIE
            //Azadanie
            string ftp1 = "This world is awesome!";
            string ftp2 = "I love c#(I'm kidding)";
            ...
            var person = new { Name = "Tom", Age = 23 };
            ...
            //3ZADANIE
            //ACzadanie
            int[][] array = { new int[2],new int[3],new int[4] };
            ...
            //Czadanie
            (int first, string second, char third, string fourth, ulong fifth) qwerty = (18, "Katya", 'f',"NY",2002);
